...
<label for="stype">Sub Type</label><br>
...
<input type="text" id="Property_Title" name="Property_Title" placeholder="Property Title" required><br>

<textarea rows = "5" cols = "64" name = "Description" placeholder="  Description"></textarea><br>

<label for="Price">Price</label><br>
<input type="number" id="Price" name="Price" placeholder="Price" required><br>

<label for="Description">Area Land</label><br>
<input type="text" id="Land_area" name="Land_area" placeholder="Area Land" required><br>
...
<input type="number" id="phone_no" name="phone_no" placeholder="Phone No" required><br>

<label for="Cell No">Cell No</label><br>
<input type="number" id="cell_no" name="cell_no" placeholder="Cell No" required><br>

<label for="Email">Email</label><br>
<input type="Email" id="Email" name="Email" placeholder="Property Title" required><br>

<label for="customer_id">Customer_id</label><br>
<input type="text" id="customer_id" name="customer_id" placeholder="Customer ID"><br>
