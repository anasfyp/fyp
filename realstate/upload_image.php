...
$customer_id=$_POST['customer_id'];
          ...
          $insert="INSERT INTO `myshop`.`realstate_admin` (`Purpose`, `Property_type`, `subtype`, `Select_city`, `Location`,`Property_Title`, `Description`, `Price`, `Land_area`, `Unit`,`Bedrooms`, `Bathrooms`, `phone_no`, `cell_no`,`Email`, `customer_id`) VALUES ('$Purpose', '$Property_type', '$subtype', '$Select_city','$Location','$Property_Title','$Description','$Price','$Land_area','$Unit','$Bedrooms','$Bathrooms','$phone_no','$cell_no','$Email','$customer_id')";
