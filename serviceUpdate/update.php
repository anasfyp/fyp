...
$q="UPDATE `serviceadd` SET `service_name`='$Service_Name',`service_img`='$service_image',`service_type`='$service_type',`service_price`='$Service_price',`service_Description`='$Service_description' WHERE `service_id`='$id'";


$query=mysqli_query($con,$q);
header('location:updateservices.php.php');
